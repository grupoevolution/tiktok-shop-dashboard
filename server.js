...
// Get monthly meta
app.get('/api/settings/meta', requireAuth, async (req, res) => {
    try {
        const result = await pool.query(
...
// Update monthly meta
app.put('/api/settings/meta', requireAuth, async (req, res) => {
    const { meta } = req.body;
...
app.get('/api/export', requireAuth, async (req, res) => {
    ...
    try {
        ...
        // Filter columns if specific account
